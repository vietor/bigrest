...
function attach_group(app, namespace, group, more, opts) {
    var interceptors = [];
    xutil.unionArray(xutil.mergeArray(more.interceptors, xutil.toArray(group.interceptor))).forEach(function(name) {
    ...
    var group_parameters = xutil.mergeArray(more.parameters, xutil.toArray(group.parameters));
    group.processors.forEach(function(processor) {
        ...
        var parameters = xutil.mergeArray(group_parameters, xutil.toArray(processor.parameters));
        ...
        xutil.toArray(processor.url).forEach(function(url) {
            xutil.toArray(processor.method).forEach(function(method) {
