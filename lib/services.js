...
function attach_group(app, namespace, group, more, opts) {
    var interceptors = [];
    xutil.unionArray(xutil.mergeArray(more.interceptors, group.interceptor)).forEach(function(name) {
    ...
    var group_parameters = xutil.mergeArray(more.parameters, group.parameters);
    group.processors.forEach(function(processor) {
        ...
        var parameters = xutil.mergeArray(group_parameters, processor.parameters);
